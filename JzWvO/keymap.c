...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [3] = LAYOUT_moonlander(
    ...
    ST_MACRO_2,     KC_LEFT_GUI,    KC_LEFT_ALT,    KC_LEFT_CTRL,   KC_LEFT_SHIFT,  KC_MINUS,                                       KC_EQUAL,       KC_RIGHT_SHIFT, DUAL_FUNC_0,    DUAL_FUNC_1,    DUAL_FUNC_2,    ST_MACRO_5,     
